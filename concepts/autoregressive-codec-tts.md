...
| [[2406.07855]] | VALL-E R: Robust and Efficient Zero-Shot TTS via Monotonic Alignment | arXiv | 2024 | Codec-merging (2x first-layer RVQ downsampling) halves AR steps with negligible quality loss; phoneme monotonic alignment closes most of the VALL-E robustness gap; WER 1.58% on LibriSpeech test-clean |
| [[2411.01156]] | Fish-Speech: LLMs for Advanced Multilingual TTS | arXiv | 2024 | Dual-AR fast-slow decomposition with GFSQ tokenizer achieving 100% codebook utilisation; eliminates G2P preprocessing via direct LLM text processing; 720k-hour multilingual training |
| [[2502.05512]] | IndexTTS: Industrial-Level Controllable Zero-Shot TTS | arXiv | 2025 | Hybrid AR+GAN pipeline with FSQ tokenizer and Conformer Perceiver speaker conditioning; demonstrates single-codebook AR can match multi-codebook systems on intelligibility with lower inference cost |
| [[2410.11190]] | Mini-Omni2: Open-source GPT-4o with Vision, Speech and Duplex Capabilities | arXiv | 2024 | AR generation of SNAC codec tokens in an end-to-end tri-modal spoken conversational agent; delayed parallel decoding for streaming speech output |
| [[2410.17799]] | OmniFlatten: End-to-end GPT Model for Seamless Voice Conversation | arXiv | 2024 | CosyVoice semantic tokens generated autoregressively in a flattened interleaved sequence for full-duplex dialogue; demonstrates AR codec TTS in full-duplex conversation without architecture changes |
| [[2412.15649]] | SLAM-Omni: Timbre-Controllable Voice Interaction with Single-Stage Training | arXiv | 2024 | Grouped semantic token prediction reduces AR sequence length 3x; decouples timbre from semantic tokens for zero-shot speaker control in spoken dialogue |
| [[2410.03751]] | Recent Advances in Speech Language Models: A Survey | arXiv | 2024 | Surveys the codec LM component of SpeechLMs; taxonomises tokenizer types, training stages, and interaction paradigms; provides systematic vocabulary for the AR codec TTS landscape |
| [[2502.06490]] | Recent Advances in Discrete Speech Tokens: A Review | arXiv | 2025 | Controlled cross-paradigm benchmarking of discrete speech tokens; covers general-purpose, semantic-distilled, and disentangled acoustic token families; TTS is one of the 11 evaluated downstream tasks |
| [[2502.07243]] | Vevo: Controllable Zero-Shot Voice Imitation with Self-Supervised Disentanglement | ICLR | 2025 | Stage 1 AR transformer generates content-style tokens; self-supervised VQ-VAE bottleneck enables annotation-free disentanglement; demonstrates AR codec approach for style-controllable voice imitation |
| [[2505.07916]] | MiniMax-Speech: Intrinsic Zero-Shot TTS with a Learnable Speaker Encoder | arXiv | 2025 | AR Transformer with jointly-trained speaker encoder achieves true zero-shot cloning (no text reference); claims top rank on Artificial Analysis Arena; WER 0.83% on SeedTTS-eval test-zh |
| [[2504.08528]] | On The Landscape of Spoken Language Models: A Comprehensive Survey | arXiv | 2025 | Maps AR codec TTS within the unified encoder-adapter-sequence-model-decoder formulation; covers coarse-to-fine, interleaved, and temporal-plus-depth AR token generation strategies |
