...
- [[2412.17048]]: What is the most effective way to address paralinguistic variability in speech tokens? Is codec design the answer, or are explicit supervision/data augmentation strategies required?
- Can variable-length speech tokenization (as in FlexiCodec [[2510.00981]]) reduce the token sequence length problem while maintaining resynthesis quality?
...
- SecoustiCodec [[2508.02849]] is designed explicitly for voice-dialogue streaming; can its explicit three-way semantic/acoustic/paralinguistic decomposition help address paralinguistic variability in speech tokens [[2412.17048]]?
...
| [[2209.03143]] | AudioLM: a Language Modeling Approach to Audio Generation | arXiv | 2022 | Establishes the semantic-plus-acoustic hierarchical LM paradigm enabling text-free speech generation indistinguishable from real speech to human listeners |
| [[2410.00037]] | Moshi: a speech-text foundation model for real-time dialogue | arXiv | 2024 | First real-time full-duplex spoken dialogue system with Inner Monologue mechanism; demonstrates the multi-stream AR paradigm with no explicit turn boundaries |
| [[2411.13577]] | WavChat: A Survey of Spoken Dialogue Models | arXiv | 2024 | Comprehensive taxonomy of cascaded vs. end-to-end spoken dialogue systems; identifies evaluation infrastructure gaps and benchmarks across all SLM capabilities |
| [[2412.02612]] | GLM-4-Voice: Towards Intelligent and Human-Like End-to-End Spoken Chatbot | arXiv | 2024 | End-to-end bilingual spoken chatbot with trillion-token speech-text interleaved pre-training; streaming thoughts template for low-latency dialogue |
| [[2410.21276]] | GPT-4o System Card | arXiv | 2024 | Reference point for natively multimodal end-to-end speech dialogue at commercial scale; demonstrates sub-400 ms human-like conversational latency |
| [[2407.10759]] | Qwen2-Audio Technical Report | arXiv | 2024 | Open-source audio-language foundation combining Whisper encoder with Qwen-7B LLM; unified voice chat and audio analysis without mode-switching prompts |
| [[2407.21783]] | The Llama 3 Herd of Models | arXiv | 2024 | Widely adopted LLM backbone for TTS and SCA systems; compositional speech integration via Conformer encoder + adapter for 34-language ASR and spoken dialogue |
| [[2412.15115]] | Qwen2.5 Technical Report | arXiv | 2024 | LLM family (0.5B–72B) adopted as backbone in instruction-conditioned and spoken-dialogue systems |
