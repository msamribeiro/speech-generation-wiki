...
**Paper:** [https://arxiv.org/abs/2508.19098](https://arxiv.org/abs/2508.19098)

**One-sentence contribution:** CLEAR replaces discrete audio tokens in autoregressive TTS with continuous VAE latents decoded via a per-token MLP rectified flow head, achieving state-of-the-art WER and lower inference latency than both discrete-token and continuous mel-spectrogram AR baselines.
