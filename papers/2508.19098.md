...
organization: "CUHK; Huawei Hong Kong Research Center"
venue: arXiv
venue_type: preprint
year: 2025
month: 8
...
related_concepts: [autoregressive-codec-tts, flow-matching, zero-shot-tts, streaming-tts]
related_papers: ["2502.11128", "2025.acl-long.313", "2407.08551", "2406.05551", "2502.03930", "2407.05407", "2412.10117", "2301.02111", "2406.05370", "2406.18009", "2303.03926", "2406.07855", "2404.03204"]
field_significance:
  level: "high"
...
> **Chun Yat Wu et al.** (CUHK; Huawei Hong Kong Research Center) · [→ Paper](https://arxiv.org/abs/2508.19098) · Demo: ✓ · Code: ?
>
...
![Overview of the CLEAR architecture (left) and the enhanced wav-VAE architecture (right). The CLEAR architecture comprises the wav-VAE encoder (purple), the autoregressive (AR) model (blue), and the rectified flow head (green). Dashed lines indicate AR decoding during inference.](assets/2508.19098/figure-1.png)
...
In-corpus references: [[2502.11128|FELLE]] — a competing continuous AR approach using coarse-to-fine flow matching on mel spectrograms, cited as a two-stage system with cumbersome training that CLEAR explicitly improves upon; [[2407.08551|MELLE]] — continuous AR baseline using Gaussian mel-spectrogram modeling; [[2406.05551|ARDiT]] — DiT-based continuous AR system cited as too computationally heavy for streaming; [[2502.03930|DiTAR]] — the primary competitor on both evaluation subsets; [[2025.acl-long.313|F5-TTS]] and [[2412.10117|CosyVoice 2]] — baselines in the subjective evaluation; [[2301.02111|VALL-E]] — the original discrete codec AR baseline.
