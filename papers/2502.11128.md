...
related_concepts: [autoregressive-codec-tts, flow-matching, zero-shot-tts, prosody-control, neural-codec]
related_papers: ["2505.13181", "2412.16846"]
---

# FELLE: Autoregressive Speech Synthesis with Token-Wise Coarse-to-Fine Flow Matching

**Paper:** [https://arxiv.org/abs/2502.11128](https://arxiv.org/abs/2502.11128)

**One-sentence contribution:** FELLE combines an autoregressive transformer language model with a token-wise coarse-to-fine flow-matching mechanism that uses the previous mel-spectrogram frame as an informed prior, achieving improved speaker similarity in zero-shot TTS while retaining near-state-of-the-art intelligibility.
...
In-corpus related papers: [[2505.13181]] (KALL-E-style continuous AR, cited as related work) and [[2412.16846]] (next-distribution prediction AR, cited as contemporaneous continuous-token work). Back-linked by [[2508.19098]] (CLEAR), which uses FELLE as a direct comparison baseline for continuous AR TTS on LibriSpeech-PC.
