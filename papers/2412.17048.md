...
related_concepts: [spoken-language-model, neural-codec, self-supervised-speech, autoregressive-codec-tts]
related_papers: []
---
...
Follow-on work building on or citing this paper: [[2510.00981]] (FlexiCodec) directly addresses the Factor B (sequence length) problem by achieving 6.25 Hz AR tokens; [[2025.acl-long.1498]] addresses a closely related phenomenon (DRI/context-dependence in RVQ encoding) from the codec training angle; [[2025.emnlp-main.989]] (VocalNet) addresses speech LLM coherence via MTP rather than tokenizer design; [[2025.acl-long.682]] (SpeechLM survey) synthesizes the broader SpeechLM landscape including the coherence problems diagnosed here; [[interspeech-2025-1289]] (TFC variable frame rate) addresses Factor B by reducing sequence length at the codec level through entropy-guided temporal allocation.
