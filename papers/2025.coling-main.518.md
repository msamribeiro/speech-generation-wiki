...
metrics:
  - name: MOS
    ...
    testset: LJSpeech test (50 samples)
  - name: WER
    value: 1.33
    system: ProsodyFlow (n=8)
    testset: LJSpeech test (50 samples)
...
![Training diagram of the ProsodyFlow model. The pitch extractor and ASR modules are pre-trained with frozen parameters. The prosody encoder utilizes the outputs from each layer of WavLM.](assets/2025.coling-main.518/figure-1.png)

![Inference diagram of the ProsodyFlow model.](assets/2025.coling-main.518/figure-2.png)
