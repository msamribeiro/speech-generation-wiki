...
This paper directly benchmarks against [[2301.02111|VALL-E]] on LibriSpeech test-clean, showing WER improvements from 12.73% to 6.59% and SPK-SIM from 0.53 to 0.73. It is complementary to [[2025.acl-long.1498|Discrete Representation Inconsistency (DRI)]], which takes the opposite approach — improving RVQ consistency rather than removing discretization — and achieves WER 3.51% (consistency-trained VALL-E, 960h). The two papers together define a key fork in codec-based TTS research: improve quantization vs. abandon it.
