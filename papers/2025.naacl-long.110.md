...
**Paper:** [https://aclanthology.org/2025.naacl-long.110](https://aclanthology.org/2025.naacl-long.110)

**One-sentence contribution:** WaveFM is a reparameterized flow matching vocoder that uses a mel-conditioned prior, multi-resolution auxiliary losses (including a novel phase angle loss), and a tailored consistency distillation method to achieve superior audio quality and single-step waveform generation.
