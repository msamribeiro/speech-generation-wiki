...
codec_used: "custom VQ-VAE tokenizers (prosody tokenizer 6.25 Hz + content-style tokenizer 12.5 Hz); Vocos-based vocoder (255M)"
...
related_concepts: [autoregressive-codec-tts, flow-matching, zero-shot-tts, prosody-control, voice-conversion, disentanglement, rlhf-speech]
related_papers: [2406.02430, 2407.05407, 2412.10117, 2301.02111, 2506.21619]
field_significance:
  level: "high"
...
> **Xueyao Zhang et al.** (The Chinese University of Hong Kong, Shenzhen / ByteDance Seed / Amphion Technology) · [→ Paper](https://arxiv.org/abs/2508.16332) · Demo: ✓ · Code: ✓
>
...
![Vevo2 inference pipeline for versatile synthesis, conversion, and editing tasks.](assets/2508.16332/figure-1.png)
...
![Unified speech and singing tokenizers of Vevo2.](assets/2508.16332/figure-2.png)
...
- [[2406.02430|Seed-TTS]] and [[2407.05407|CosyVoice]] provide the two-stage AR+FM architectural foundation that Vevo2 builds upon and extends to the singing domain.
- [[2412.10117|CosyVoice 2]] serves as the primary zero-shot TTS baseline; Vevo2 achieves competitive regular speech quality despite operating at half its content-style tokenizer frame rate.
- [[2301.02111|VALL-E]] is the originating paper for the AR codec language model lineage that underpins Vevo2's AR content-style modeling stage.
- [[2506.21619|IndexTTS2]] is an in-corpus AR-based TTS system situating Vevo2 within the current state of zero-shot speech generation.
