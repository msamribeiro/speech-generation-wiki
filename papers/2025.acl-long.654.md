...
related_concepts: ["neural-codec", "autoregressive-codec-tts", "zero-shot-tts", "self-supervised-speech", "spoken-language-model"]
related_papers: []
---

# Language-Codec: Bridging Discrete Codec Representations and Speech Language Models

**Paper:** [https://aclanthology.org/2025.acl-long.654](https://aclanthology.org/2025.acl-long.654)

**One-sentence contribution:** Language-Codec introduces a Masked Channel Residual Vector Quantization (MCRVQ) mechanism that redistributes information load across RVQ codebook channels, making the first channel easier to predict from text and thereby improving downstream autoregressive speech language model performance.
