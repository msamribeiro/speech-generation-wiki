...
**Paper:** [https://arxiv.org/abs/2510.05758](https://arxiv.org/abs/2510.05758)

**One-sentence contribution:** EMORL-TTS applies reinforcement learning (GRPO) on top of a frozen LLM-based TTS model to achieve fine-grained, continuously controllable emotion intensity and prosodic emphasis in a discrete-token speech generation framework.
