...
codec_used: "none (Vocos vocoder for waveform synthesis from mel features)"
...
metrics:
  ...
  - name: SMOS
    value: 3.86
    system: ZipVoice-Dialog
    testset: test-zh (subjective)
code_available: true
demo_available: null
url: "https://arxiv.org/abs/2507.09318"
related_concepts: [flow-matching, zero-shot-tts, spoken-language-model, evaluation-metrics]
related_papers: []
field_significance:
  level: "high"
...
![Illustration of ZipVoice-Dialog training (left) and inference (right).](assets/2507.09318/figure-1.png)
