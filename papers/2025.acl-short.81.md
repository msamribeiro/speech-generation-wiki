...
**Paper:** [https://aclanthology.org/2025.acl-short.81](https://aclanthology.org/2025.acl-short.81)

**One-sentence contribution:** This paper presents PhoAudiobook, a 941-hour high-quality Vietnamese audiobook dataset with speaker identity labels, and benchmarks three zero-shot TTS systems (VALL-E, VoiceCraft, XTTS-v2) trained on it against the prior viVoice-trained baseline.
