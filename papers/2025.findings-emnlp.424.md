...
**Paper:** [https://aclanthology.org/2025.findings-emnlp.424](https://aclanthology.org/2025.findings-emnlp.424)

**One-sentence contribution:** InteractSpeech is a 150-hour English spoken dialogue dataset with over 10 types of interaction annotations (interruptions, backchannels, gaps, pauses) and precise speaker timestamps, created via multi-stage LLM prompt programming and advanced TTS synthesis, that enables models to learn fine-grained turn-taking and interactive conversational behavior.
