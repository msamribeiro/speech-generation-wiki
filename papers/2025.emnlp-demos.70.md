...
metrics:
  ...
  - name: MOS
    value: 3.65
    system: OpenS2S
    testset: VoiceBench-commoneval
  - name: MOS
    value: 3.66
    system: OpenS2S
    testset: VoiceBench-wildvoice
  - name: MOS
    value: 42.89
    system: OpenS2S
...
- [[2501.04561|OpenOmni]] — in-corpus reference; contemporaneous open-source omnimodal speech LLM
- [[2502.17810|URO-Bench]] — in-corpus reference; benchmark used for empathy evaluation
- [[2025.emnlp-main.989|VocalNet]] — contemporaneous approach to speech LLM efficiency; where OpenS2S targets empathy and open-source reproducibility, VocalNet targets data efficiency and WER via MTP; complementary SCA advances from EMNLP 2025
- [[2025.acl-long.682|SpeechLM survey]] — contextualizes OpenS2S's architecture within the broader aligned multimodal LLM paradigm
