...
**Paper:** [https://aclanthology.org/2025.emnlp-demos.70](https://aclanthology.org/2025.emnlp-demos.70)

**One-sentence contribution:** OpenS2S is a fully open-source, end-to-end large speech language model for empathetic speech-to-speech interaction, featuring a streaming interleaved decoding architecture and an automated data construction pipeline that synthesizes bilingual empathetic speech dialogues using LLMs and controllable TTS.
