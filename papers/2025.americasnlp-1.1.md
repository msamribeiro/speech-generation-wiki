...
**Paper:** [https://aclanthology.org/2025.americasnlp-1.1](https://aclanthology.org/2025.americasnlp-1.1)

**One-sentence contribution:** The first TTS model and speech dataset for Shipibo-Konibo, a low-resource Panoan indigenous language of Peru, using Tacotron 2 fine-tuned from a Latin American Spanish checkpoint and HiFi-GAN, achieving MOS 4.01 and IR 88.56% with only 4h 37m of training data.
