...
**Paper:** [https://arxiv.org/abs/2504.10352](https://arxiv.org/abs/2504.10352)

**One-sentence contribution:** PALLE introduces pseudo-autoregressive (PAR) codec language modeling — a new paradigm combining AR temporal ordering with NAR parallel generation — achieving state-of-the-art zero-shot TTS quality on LibriTTS-trained models while enabling up to 10x faster inference than AR systems, and outperforming large-scale-trained systems including F5-TTS, E2-TTS, and MaskGCT.
