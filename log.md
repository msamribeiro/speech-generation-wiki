...
- ingest | 2601.00303 | DepFlow: Disentangled Speech Generation to Mitigate Semantic Bias in Depression Detection | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.01459 | OV-InstructTTS: Towards Open-Vocabulary Instruct Text-to-Speech | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.01568 | MM-Sonate: Multimodal Controllable Audio-Video Generation with Zero-Shot Voice Cloning | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.04233 | LEMAS: A 150K-Hour Large-scale Extensible Multilingual Audio Suite with Generative Speech Models | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.02073 | Towards Prosodically Informed Mizo TTS without Explicit Tone Markings | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.02753 | Vclip: Face-based Speaker Generation by Face-voice Association Learning | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.02776 | UniSRCodec: Unified and Low-Bitrate Single Codebook Codec with Sub-Band Reconstruction | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.03170 | TED-TTS: Training-Free Intra-Utterance Emotion and Duration Control for Text-to-Speech Synthesis | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.03632 | ReStyle-TTS: Relative and Continuous Style Control for Zero-Shot Speech Synthesis | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.03892 | Lightweight and perceptually-guided voice conversion for electro-laryngeal speech | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.05329 | CosyEdit: Unlocking End-to-End Speech Editing Capability from Zero-Shot Text-to-Speech Models | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.05554 | SPAM: Style Prompt Adherence Metric for Prompt-based TTS | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.05564 | The ICASSP 2026 HumDial Challenge: Benchmarking Human-like Spoken Dialogue Systems in the LLM Era | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2505.15727 | VocalBench: Benchmarking the Vocal Conversational Abilities for Speech Interaction Models | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.08450 | Decoding Order Matters in Autoregressive Speech Synthesis | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.09239 | DSA-Tokenizer: Disentangled Semantic-Acoustic Tokenization via Flow Matching-based Hierarchical Fusion | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2602.06053 | PersonaPlex: Voice and Role Control for Full Duplex Conversational Speech Models | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.10629 | VoiceSculptor: Your Voice, Designed By You | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2506.12537 | What Makes a Good Speech Tokenizer for LLM-Centric Speech Generation? A Systematic Study | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.11141 | FlashLabs Chroma 1.0: A Real-Time End-to-End Spoken Dialogue Model with Personalized Voice Cloning | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.16225 | ES4R: Speech Encoding Based on Prepositive Affective Modeling for Empathetic Response Generation | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.12205 | Do Neural Codecs Generalize? A Controlled Study Across Unseen Languages and Non-Speech Tasks | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5
- ingest | 2601.12289 | ParaMETA: Towards Learning Disentangled Paralinguistic Speaking Styles Representations from Speech | arXiv 2026 | runtime: claude-code | provider: anthropic | model: claude-sonnet-5

## 2026-08-02

- integrate | 10 papers | singing | Phase 1 batch 1, Phase 1 complete | first and final integration batch for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 10 eligible papers, skipped 0 Tier 2 pages, and excluded 9 Q4-or-later pages; processed 2304.09116, interspeech-2025-0347, interspeech-2025-0816, interspeech-2025-1364, interspeech-2025-1397, interspeech-2025-1531, 2509.07038, 2509.15629, 2509.19883, 2509.22718; 43 claims preserved from 8 structured and 2 legacy pages, all with source citations; authoritative closure audit found zero eligible papers remaining and zero extraneous entries; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml is 157 after recent Q4 ingestion | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | singing (10 papers) | 17 claim_clusters | 4 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 9/10 papers to reciprocal architecture families with 12 memberships, leaving one architecture-unspecified challenge and evaluation paper as a legitimate outlier; all 17 clusters remain emerging, reflecting a small and heterogeneous evidence base spanning shared speech–singing training, high-pitch codec coverage, cross-modal identity alignment, cycle training, few-step diffusion, explicit F0 and signal controls, style–naturalness trade-offs, SSL timbre leakage, dynamic singing techniques, metric validity, prompt regularization, visual timing, staged multimodal training, and limits of direct speech-architecture transfer; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 1 expected method-family coverage warning | runtime: codex | provider: openai | model: gpt-5
- integrate | 1 paper | fine-tuning | Phase 1 batch 1, Phase 1 complete | first and final integration batch for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found one eligible paper, no Tier 2 pages, and no Q4-or-later exclusions; processed 2508.18006; 4 claims preserved from one legacy page, all with source citations; authoritative closure audit found zero eligible papers remaining and zero extraneous entries; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 157 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | fine-tuning (1 paper) | 2 claim_clusters | 0 method_families | 2 reassessment_queue items | first synthesis pass after Phase 1 closed; created two emerging clusters covering adapter-based preservation of TTS capability and the dependence of cross-lingual adaptation on target-language speaker diversity; no method family was created because the concept has only one paper and the schema requires at least two papers per family; added 4 open questions and 2 trend notes; Phase 2 health check passed with 0 errors and 1 expected method-family coverage warning; all 23 supported concepts are now fully integrated for Q3 and earlier | runtime: codex | provider: openai | model: gpt-5
...
- integrate | 8 papers | transformer-enc-dec-tts | Phase 1 batch 2, Phase 1 complete | Q3-scoped oldest-first final batch, 20 → 28 of 28; processed interspeech-2025-2189, interspeech-2025-2586, 2508.13028, 2508.17031, 2509.01391, 2509.06074, 2509.11084, 2509.19592; 33 claims preserved from 5 structured and 3 legacy pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, no Tier 2 pages, and 5 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | transformer-enc-dec-tts (28 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 27/28 papers to reciprocal architecture families with 43 memberships, leaving one architecture-unspecified evaluation paper as a legitimate outlier; clusters comprise 4 strongly_supported and 13 emerging, covering end-to-end sequence-to-sequence modeling, decoder attention stability, multi-scale encoders and post-nets, mel intermediates, explicit and forced-alignment durations, monotonic and positional alignment, variance modeling, hierarchical and stochastic prosody, discrete SSL controls, unseen-speaker generalization, multimodal cross-attention, disentanglement, adversarial acoustic refinement, and deployment constraints; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 1 expected method-family coverage warning | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | streaming-tts (54 papers) | 17 claim_clusters | 5 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 51/54 papers to reciprocal architecture families with 74 memberships, leaving 3 architecture-unspecified evaluation and system-level papers as legitimate outliers; clusters comprise 13 strongly_supported and 4 emerging, covering incremental latency, chunk policy, causality and lookahead, distillation, interleaved text–speech generation, parallel decoding, low-rate tokenization, unified streaming/offline modes, full duplex, turn taking, training curricula, modular versus end-to-end systems, speech reasoning, causal codecs and vocoders, continuous generators, interaction-aware evaluation, and cross-domain robustness; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 3 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | emotion-synthesis | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 73 eligible papers, skipped 4 Tier 2 pages, and excluded 20 Q4-or-later pages; processed 2312.01479, 2402.05755, 2407.05407, 2409.00750, 2501.06282, 2025.findings-naacl.38, 2505.15772, 2506.16381, 2507.00808, 2507.08012, 2507.04349, 2507.04598, 2507.04817, 2507.21138, 2507.18119, 2025.findings-acl.101, 2025.findings-acl.687, 2503.11026, 2025.ccl-1.77, 2025.sigdial-1.27; 90 claims preserved from 14 structured and 6 legacy pages, all with source citations; 53 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | emotion-synthesis | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 73; processed 2508.02038, 2508.03543, 2508.04195, 2508.04585, 2507.20091, 2508.05385, 2508.06890, 2508.07273, 2508.07302, 2508.08095, 2504.12867, 2508.09600, 2508.11273, interspeech-2025-0166, interspeech-2025-0203, interspeech-2025-0408, interspeech-2025-0648, interspeech-2025-0704, interspeech-2025-0706, interspeech-2025-0754; 89 claims preserved from 2 structured and 18 legacy pages, all with source citations; 33 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | emotion-synthesis | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 73; processed interspeech-2025-0756, interspeech-2025-0815, interspeech-2025-0948, interspeech-2025-1101, interspeech-2025-1115, interspeech-2025-1192, interspeech-2025-1210, interspeech-2025-1394, interspeech-2025-1638, interspeech-2025-2075, interspeech-2025-2586, 2508.13028, 2508.16188, 2508.17623, 2509.02020, 2506.21619, 2509.03940, 2509.04072, 2509.06502, 2509.09716; 89 claims preserved from 10 structured and 10 legacy pages, all with source citations; 13 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 13 papers | emotion-synthesis | Phase 1 batch 4, Phase 1 complete | Q3-scoped oldest-first final batch, 60 → 73 of 73; processed 2504.20581, 2509.13989, 2509.14946, 2509.15253, 2509.15626, 2509.15845, 2509.16010, 2509.20378, 2509.17516, 2501.04561, 2505.10599, 2509.25416, 2509.26514; 56 claims preserved from 13 structured pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 4 Tier 2 pages skipped, and 20 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | emotion-synthesis (73 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 62/73 papers to reciprocal architecture families with 99 memberships, leaving 11 architecture-unspecified evaluation, benchmark, and system-level papers as legitimate outliers; clusters comprise 14 strongly_supported and 3 emerging, covering explicit conditioning, natural-language control, temporal granularity, identity–emotion disentanglement, control trade-offs, multimodal and dialogue context, categorical–continuous representations, data and annotation limits, expressive transfer, flow/diffusion control, paralinguistic events, preference optimization, metric validity, multilingual transfer, and sustained coherence; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 11 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | gan-vocoder | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 60 eligible papers, skipped 0 Tier 2 pages, and excluded 12 Q4-or-later pages; processed 1609.03499, 1712.05884, 2006.04558, 2010.05646, 2104.00355, 2106.15561, 2206.04658, 2210.13438, 2305.02765, 2306.00814, 2409.05377, 2411.01156, 2025.chipsal-1.18, 2502.05512, iclr-2025-tQ1PmLfPBL, iclr-2025-uxDFlPGRLX, 2025.findings-naacl.130, 2025.findings-naacl.279, 2025.naacl-long.110, 2025.naacl-long.591; 91 claims preserved from 6 structured and 14 legacy pages, all with source citations; 40 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | gan-vocoder | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 60; processed 2025.naacl-short.65, 2025.americasnlp-1.1, 2507.01611, 2507.08319, 2025.findings-acl.115, 2507.20731, 2508.01796, 2508.05207, 2508.06870, 2508.07711, 2508.12001, interspeech-2025-0347, interspeech-2025-0406, interspeech-2025-0455, interspeech-2025-0854, interspeech-2025-0998, interspeech-2025-1081, interspeech-2025-1122, interspeech-2025-1747, interspeech-2025-1763; 84 claims preserved from 10 structured and 10 legacy pages, all with source citations; 20 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | gan-vocoder | Phase 1 batch 3, Phase 1 complete | Q3-scoped oldest-first final batch, 40 → 60 of 60; processed interspeech-2025-1819, interspeech-2025-2031, interspeech-2025-2151, interspeech-2025-2573, interspeech-2025-2586, interspeech-2025-2726, interspeech-2025-2739, 2508.18006, 2507.14534, 2509.02244, 2509.04667, 2509.07038, 2509.08379, 2509.13667, 2509.15085, 2509.18806, 2509.19025, 2509.21968, 2509.24773, 2510.00264; 84 claims preserved from 17 structured and 3 legacy pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, no Tier 2 pages, and 12 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | gan-vocoder (60 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned all 60 papers to reciprocal architecture families with 98 memberships; clusters comprise 12 strongly_supported and 5 emerging, covering GAN latency and quality, discriminator design, periodic and spectral discrimination, frequency-domain generation, explicit phase, anti-aliasing, conditioning mismatch, data diversity, scaling stability, signal-processing constraints, causal streaming, iterative alternatives, codec decoding, quantization, metric validity, upstream bottlenecks, and low-resource transfer; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | streaming-tts | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 54 eligible papers, skipped 5 Tier 2 pages, and excluded 17 Q4-or-later pages; processed 2402.08093, 2408.02622, 2408.16725, 2409.06666, 2410.00037, 2410.11190, 2410.17799, 2411.00774, 2411.13577, 2411.18803, 2412.02612, 2412.10117, 2502.11946, iclr-2025-tQ1PmLfPBL, 2025.naacl-srw.6, 2505.02625, 2507.12197, 2025.acl-demo.37, 2025.acl-long.817, 2025.acl-long.912; 92 claims preserved from 4 structured and 16 legacy pages, all with source citations; 34 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | streaming-tts | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 54; processed 2025.findings-acl.1051, 2507.17527, 2025.sigdial-1.51, 2507.22746, 2508.02849, 2504.10352, 2508.05207, 2508.06262, 2508.07375, interspeech-2025-0669, interspeech-2025-0874, interspeech-2025-1084, interspeech-2025-1289, interspeech-2025-1819, interspeech-2025-2447, interspeech-2025-2449, interspeech-2025-2564, 2508.15827, 2508.19098, 2507.14534; 91 claims preserved from 5 structured and 15 legacy pages, all with source citations; 14 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
- integrate | 14 papers | streaming-tts | Phase 1 batch 3, Phase 1 complete | Q3-scoped oldest-first final batch, 40 → 54 of 54; processed 2509.02020, 2509.04667, 2509.06502, 2509.09174, 2509.13667, 2509.13670, 2509.14784, 2509.15085, 2509.15969, 2509.16195, 2509.17765, 2509.23147, 2509.25131, 2509.26542; 64 claims preserved from 12 structured and 2 legacy pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 5 Tier 2 pages skipped, and 17 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 142 | runtime: codex | provider: openai | model: gpt-5
...
- integrate | 20 papers | multilingual-tts | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 75; processed 2505.17589, 2507.15272, 2507.16875, 2507.21138, 2507.18119, 2025.acl-industry.42, 2025.acl-long.313, 2025.acl-long.598, 2025.acl-long.681, 2025.acl-short.81, 2025.findings-acl.687, 2025.findings-acl.71, 2025.findings-acl.75, 2507.17527, 2503.11026, 2025.unlp-1.11, 2025.ccl-1.80, 2508.14049, 2508.04195, 2508.05385; 89 claims preserved from 11 structured and 9 legacy pages, all with source citations; 35 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 123 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | multilingual-tts | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 75; processed 2508.07302, 2508.07426, 2508.08715, 2508.09702, 2508.09767, 2508.11273, interspeech-2025-0143, interspeech-2025-0469, interspeech-2025-0762, interspeech-2025-0973, interspeech-2025-1034, interspeech-2025-1344, interspeech-2025-1550, interspeech-2025-2031, interspeech-2025-2043, interspeech-2025-2573, interspeech-2025-gourav25_interspeech, interspeech-2025-raju25_interspeech, 2508.15442, 2508.17494; 85 claims preserved from 5 structured and 15 legacy pages, all with source citations; 15 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 123 | runtime: codex | provider: openai | model: gpt-5
- integrate | 15 papers | multilingual-tts | Phase 1 batch 4, Phase 1 complete | Q3-scoped oldest-first final batch, 60 → 75 of 75; processed 2508.18006, 2509.01391, 2509.04702, 2509.05863, 2509.14270, 2509.14579, 2509.14784, 2509.17765, 2509.18060, 2501.04561, 2509.20086, 2509.22727, 2509.22062, 2509.23147, 2509.25131; 61 claims preserved from 13 structured and 2 legacy pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 13 Tier 2 pages skipped, and 25 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 123 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | multilingual-tts (75 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 67/75 papers to reciprocal architecture families with 104 memberships, leaving 8 architecture-unspecified evaluation, corpus, and peripheral-task papers as legitimate outliers; clusters comprise 15 strongly_supported and 2 emerging, covering low-resource transfer, data imbalance, cross-lingual cloning, language conditioning, shared phonetics, code-switching, text front ends, unseen-language transfer, language adaptation, parameter-efficient extension, data scale, accent leakage, language-sensitive alignment, multilingual evaluation, codec language models, flow/diffusion scaling, and dialect identity; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 8 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | speaker-adaptation | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 79 eligible papers, skipped 1 Tier 2 page, and excluded 12 Q4-or-later pages; processed 1609.03499, 1904.02882, 2301.02111, 2305.07243, 2406.04904, 2406.05370, 2406.07855, 2406.18009, 2407.08551, 2409.03283, 2502.18924, iclr-2025-cuFzE8Jlvb, 2025.findings-naacl.130, 2025.findings-naacl.279, 2025.naacl-short.65, 2025.americasnlp-1.1, 2505.07916, 2506.13053, 2507.00808, 2507.02380; 88 claims preserved from 6 structured and 14 legacy pages, all with source citations; 59 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | speaker-adaptation | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 79; processed 2507.08319, 2507.09282, 2506.18296, 2507.15272, 2507.16875, 2505.15670, 2025.acl-industry.42, 2025.acl-long.790, 2025.acl-long.87, 2507.20140, 2503.11026, 2025.ccl-1.77, 2508.14049, 2508.04141, 2508.04996, 2508.07426, 2508.08399, 2508.08715, 2508.09702, 2508.09767; 85 claims preserved from 11 structured and 9 legacy pages, all with source citations; 39 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | speaker-adaptation | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 79; processed interspeech-2025-0047, interspeech-2025-0596, interspeech-2025-0787, interspeech-2025-0816, interspeech-2025-0854, interspeech-2025-1034, interspeech-2025-1344, interspeech-2025-1434, interspeech-2025-1440, interspeech-2025-1478, interspeech-2025-1536, interspeech-2025-1538, interspeech-2025-1638, interspeech-2025-1726, interspeech-2025-1747, interspeech-2025-2679, interspeech-2025-2765, interspeech-2025-2815, interspeech-2025-raju25_interspeech, 2508.15565; 79 claims preserved from 10 structured and 10 legacy pages, all with source citations; 19 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 124 → 123 | runtime: codex | provider: openai | model: gpt-5
- integrate | 19 papers | speaker-adaptation | Phase 1 batch 4, Phase 1 complete | Q3-scoped oldest-first final batch, 60 → 79 of 79; processed 2508.15931, 2508.17031, 2508.18006, 2411.19770, 2509.00675, 2509.04667, 2509.04702, 2509.07376, 2506.04077, 2509.09631, 2509.14270, 2412.16846, 2509.15253, 2509.15462, 2509.15629, 2509.15969, 2509.16010, 2509.22718, 2509.22727; 84 claims preserved from 13 structured and 6 legacy pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 1 Tier 2 page skipped, and 12 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 123 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | speaker-adaptation (79 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 70/79 papers to reciprocal architecture families with 102 memberships, leaving 9 architecture-unspecified corpus, evaluation, assistive, and peripheral-task papers as legitimate outliers; clusters comprise 15 strongly_supported and 2 emerging, covering shared multi-speaker structure, reference conditioning, speaker encoders, prompt quality, few-shot and parameter-efficient adaptation, identity–style disentanglement, identity–expressiveness trade-offs, multilingual transfer, continuous representations, codec prompting, flow/diffusion adaptation, data scale, metric validity, mismatch robustness, assistive voices, and privacy; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 9 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | self-supervised-speech (146 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 127/146 papers to reciprocal architecture families with 170 memberships, leaving 19 architecture-unspecified survey, evaluation, dialogue, codec, and peripheral-system papers as legitimate outliers; clusters comprise 13 strongly_supported, 2 emerging, and 2 contested, covering reusable pretrained representations, linguistic content, layer selection, speaker/prosody leakage, disentanglement, discrete units, continuous–discrete trade-offs, semantic–acoustic hierarchies, low-resource and multilingual transfer, robustness, scaling limits, task adaptation, unified speech models, generation conditioning, low-bitrate codecs, and automatic-judge validity; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 19 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 146 eligible papers, skipped 9 Tier 2 pages, and excluded 16 Q4-or-later pages; processed 2104.00355, 2204.02152, 2209.03143, 2212.04356, 2301.11325, 2305.02765, 2305.09636, 2305.11000, 2306.12925, 2308.16692, 2402.05755, 2402.08093, 2402.13236, 2408.02622, 2409.00750, 2409.03283, 2409.06666, 2410.00037, 2410.03751, 2411.13577; 92 claims preserved from 20 legacy pages, all with source citations; 126 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 146; processed 2411.19842, 2412.04724, 2409.09098, 2025.coling-main.518, 2502.04128, 2502.06490, 2502.07243, 2502.17239, 2503.01710, 2504.08528, 2504.10344, iclr-2025-dGSOn7sdWg, 2025.findings-naacl.130, 2025.findings-naacl.471, 2025.naacl-demo.12, 2025.naacl-long.484, 2025.naacl-short.65, 2025.iwsds-1.11, 2505.13000, 2506.10274; 93 claims preserved from 8 structured and 12 legacy pages, all with source citations; 106 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 146; processed 2507.00808, 2507.02176, 2507.03887, 2507.03912, 2507.08012, 2507.04349, 2507.06116, 2412.18603, 2507.16632, 2507.18897, 2025.acl-demo.37, 2025.acl-long.681, 2025.acl-long.682, 2025.acl-long.790, 2025.acl-long.817, 2025.acl-long.87, 2025.acl-long.997, 2025.findings-acl.631, 2025.findings-acl.71, 2025.findings-acl.75; 88 claims preserved from 17 structured and 3 legacy pages, all with source citations; 86 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 146; processed 2503.11026, 2025.iwslt-1.5, 2025.sigdial-1.21, 2025.sigdial-1.51, 2508.14049, 2508.04141, 2508.04996, 2508.05385, 2508.06890, 2508.07273, 2508.07375, 2508.08399, 2508.09600, 2508.11224, 2508.11273, interspeech-2025-0115, interspeech-2025-0143, interspeech-2025-0166, interspeech-2025-0203, interspeech-2025-0246; 85 claims preserved from 5 structured and 15 legacy pages, all with source citations; 66 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 5 | Q3-scoped oldest-first continuation, 80 → 100 of 146; processed interspeech-2025-0305, interspeech-2025-0310, interspeech-2025-0383, interspeech-2025-0433, interspeech-2025-0438, interspeech-2025-0468, interspeech-2025-0506, interspeech-2025-0656, interspeech-2025-0706, interspeech-2025-0723, interspeech-2025-0756, interspeech-2025-0815, interspeech-2025-0816, interspeech-2025-0948, interspeech-2025-0973, interspeech-2025-0998, interspeech-2025-1101, interspeech-2025-1106, interspeech-2025-1210, interspeech-2025-1229; 87 claims preserved from 12 structured and 8 legacy pages, all with source citations; 46 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 6 | Q3-scoped oldest-first continuation, 100 → 120 of 146; processed interspeech-2025-1236, interspeech-2025-1394, interspeech-2025-1397, interspeech-2025-1434, interspeech-2025-1440, interspeech-2025-1478, interspeech-2025-1531, interspeech-2025-1595, interspeech-2025-1625, interspeech-2025-1639, interspeech-2025-1776, interspeech-2025-1779, interspeech-2025-2043, interspeech-2025-2075, interspeech-2025-2660, interspeech-2025-2684, interspeech-2025-cho25c_interspeech, 2508.15565, 2508.16188, 2508.16790; 83 claims preserved from 12 structured and 8 legacy pages, all with source citations; 26 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | self-supervised-speech | Phase 1 batch 7 | Q3-scoped oldest-first continuation, 120 → 140 of 146; processed 2411.19770, 2507.14534, 2509.00503, 2509.00675, 2509.01391, 2509.03292, 2509.05359, 2509.04072, 2509.04667, 2509.06074, 2509.09174, 2509.09201, 2509.09550, 2509.11425, 2509.13068, 2509.15626, 2509.16195, 2509.20378, 2509.17006, 2509.17143; 90 claims preserved from 14 structured and 6 legacy pages, all with source citations; 6 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
- integrate | 6 papers | self-supervised-speech | Phase 1 batch 8, Phase 1 complete | Q3-scoped oldest-first final batch, 140 → 146 of 146; processed 2509.19928, 2509.20485, 2509.21968, 2509.22167, 2509.24773, 2509.26276; 26 claims preserved from 6 structured pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 9 Tier 2 pages skipped, and 16 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 124 | runtime: codex | provider: openai | model: gpt-5
...
- integrate | 20 papers | neural-codec | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 183; processed 2402.13236, 2403.03100, 2403.16973, 2404.03204, 2406.00654, 2406.04904, 2406.05370, 2406.07855, 2407.05407, 2407.08551, 2408.16532, 2408.16725, 2409.00750, 2409.03283, 2409.05377, 2409.06666, 2410.00037, 2410.03751, 2410.11190, 2410.17799; 91 claims preserved from 20 legacy pages, all with source citations; three Appendix-only citations were normalized into explicit `source` fields; 143 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 118 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 183; processed 2411.00774, 2411.01156, 2411.13577, 2411.17607, 2411.18803, 2411.19842, 2412.02612, 2412.10117, 2412.15649, 2502.04128, 2502.05512, 2502.06490, 2502.11946, 2502.17239, 2502.18924, 2503.01710, 2503.14345, 2504.08528, 2504.10344, iclr-2025-868masI331; 96 claims preserved from 1 structured and 19 legacy pages, all with source citations; 123 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 118 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 183; processed iclr-2025-cuFzE8Jlvb, iclr-2025-dGSOn7sdWg, iclr-2025-hQvX9MBowC, iclr-2025-tQ1PmLfPBL, iclr-2025-uxDFlPGRLX, 2025.findings-naacl.184, 2025.naacl-demo.12, 2025.naacl-long.591, 2025.naacl-srw.6, 2505.02625, 2505.13000, 2506.10274, 2507.02380, 2507.01348, 2506.23325, 2412.18603, 2507.07799, 2507.09070, 2507.12197, 2507.16632; 94 claims preserved from 15 structured and 5 legacy pages, all with source citations; 103 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 118 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 5 | Q3-scoped oldest-first continuation, 80 → 100 of 183; processed 2507.21138, 2505.15670, 2507.18897, 2025.acl-long.1043, 2025.acl-long.1498, 2025.acl-long.346, 2025.acl-long.65, 2025.acl-long.654, 2025.acl-long.682, 2025.acl-long.817, 2025.acl-long.87, 2025.acl-long.912, 2025.acl-long.937, 2025.acl-short.81, 2025.findings-acl.1051, 2025.findings-acl.115, 2025.findings-ijcnlp.49, 2025.ccl-1.80, 2507.22746, 2508.02849; 94 claims preserved from 8 structured and 12 legacy pages, all with source citations; 83 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 118 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 6 | Q3-scoped oldest-first continuation, 100 → 120 of 183; processed 2504.10352, 2508.04141, 2508.04585, 2508.05207, 2508.06262, 2508.07302, 2508.08399, 2508.08961, 2504.12867, 2508.11224, 2508.11326, interspeech-2025-0115, interspeech-2025-0196, interspeech-2025-0246, interspeech-2025-0253, interspeech-2025-0310, interspeech-2025-0319, interspeech-2025-0347, interspeech-2025-0355, interspeech-2025-0464; 89 claims preserved from 3 structured and 17 legacy pages, all with source citations; 63 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 118 → 117 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 7 | Q3-scoped oldest-first continuation, 120 → 140 of 183; processed interspeech-2025-0468, interspeech-2025-0506, interspeech-2025-0575, interspeech-2025-0669, interspeech-2025-0874, interspeech-2025-0984, interspeech-2025-0989, interspeech-2025-1020, interspeech-2025-1084, interspeech-2025-1106, interspeech-2025-1289, interspeech-2025-1440, interspeech-2025-1538, interspeech-2025-1639, interspeech-2025-1641, interspeech-2025-1776, interspeech-2025-1993, interspeech-2025-2075, interspeech-2025-2447, interspeech-2025-2564; 85 claims preserved from 9 structured and 11 legacy pages, all with source citations; 43 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 117 → 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 8 | Q3-scoped oldest-first continuation, 140 → 160 of 183; processed interspeech-2025-2726, 2508.15827, 2508.15931, 2508.16790, 2508.19205, 2508.20660, 2509.00503, 2509.02020, 2509.02244, 2509.04685, 2509.05863, 2509.09174, 2509.09201, 2509.09550, 2509.09631, 2509.11425, 2509.13068, 2412.16846, 2509.13670, 2509.14882; 92 claims preserved from 11 structured and 9 legacy pages, all with source citations; 23 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | neural-codec | Phase 1 batch 9 | Q3-scoped oldest-first continuation, 160 → 180 of 183; processed 2509.15462, 2509.15969, 2509.16195, 2509.17006, 2509.17143, 2509.17765, 2501.04561, 2509.18823, 2509.19025, 2509.19186, 2509.19592, 2509.19883, 2509.20485, 2509.20802, 2509.21968, 2509.22062, 2509.22167, 2509.24457, 2509.24570, 2509.24650; 85 claims preserved from 19 structured and 1 legacy page, all with source citations; 3 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 3 papers | neural-codec | Phase 1 batch 10, Phase 1 complete | Q3-scoped oldest-first final batch, 180 → 183 of 183; processed 2509.25131, 2509.26276, 2510.00264; 12 claims preserved from 3 structured pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 9 Tier 2 pages skipped, and 45 Q4-or-later pages excluded; Phase 1 only, with all 183 method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | neural-codec (183 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 171/183 papers to at least one reciprocal architecture family with 261 memberships, leaving 12 architecture-unspecified survey, evaluation, or peripheral generation papers as legitimate outliers; all 17 clusters strongly_supported, covering low-bitrate quality, residual quantization, semantic–acoustic hierarchy, SSL guidance, language-model compatibility, quantizer structure, codebook utilization, adversarial reconstruction, decoder capacity, speaker/prosody entanglement, continuous–discrete trade-offs, token rate, parallel latent generation, intelligibility, multilingual transfer, unified speech systems, and evaluation validity; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 12 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | voice-conversion | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 87 eligible papers, skipped 1 Tier 2 page, and excluded 17 Q4-or-later pages; processed 2104.00355, 2310.00704, 2312.01479, 2403.03100, 2406.02430, 2411.09943, 2412.04724, 2409.09098, 2502.07243, 2025.naacl-short.65, 2507.02176, 2507.04817, 2507.01348, 2507.09070, 2507.09282, 2507.09310, 2506.18296, 2507.10985, 2025.acl-demo.37, 2025.acl-long.790; 85 claims preserved from 11 structured and 9 legacy pages, all with source citations; 67 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | voice-conversion | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 87; processed 2025.acl-long.87, 2508.00317, 2508.02038, 2508.04996, 2508.06890, 2508.08399, 2508.08961, interspeech-2025-0115, interspeech-2025-0203, interspeech-2025-0305, interspeech-2025-0383, interspeech-2025-0433, interspeech-2025-0438, interspeech-2025-0464, interspeech-2025-0575, interspeech-2025-0656, interspeech-2025-0787, interspeech-2025-0815, interspeech-2025-0816, interspeech-2025-0902; 85 claims preserved from 7 structured and 13 legacy pages, all with source citations; 47 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | voice-conversion | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 87; processed interspeech-2025-0948, interspeech-2025-0998, interspeech-2025-1081, interspeech-2025-1101, interspeech-2025-1106, interspeech-2025-1210, interspeech-2025-1229, interspeech-2025-1397, interspeech-2025-1434, interspeech-2025-1440, interspeech-2025-1531, interspeech-2025-1538, interspeech-2025-1550, interspeech-2025-1625, interspeech-2025-1639, interspeech-2025-1747, interspeech-2025-1763, interspeech-2025-1779, interspeech-2025-1993, interspeech-2025-2043; 86 claims preserved from 14 structured and 6 legacy pages, all with source citations; 27 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | voice-conversion | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 87; processed interspeech-2025-2151, interspeech-2025-2283, interspeech-2025-2684, interspeech-2025-bokkahallisatish25_interspeech, interspeech-2025-cho25c_interspeech, 2508.15565, 2508.16332, 2411.19770, 2507.14534, 2509.00503, 2509.04667, 2509.07376, 2509.08379, 2509.09201, 2509.14270, 2509.13068, 2504.20581, 2509.14579, 2509.15462, 2509.15629; 86 claims preserved from 16 structured and 4 legacy pages, all with source citations; 7 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | 7 papers | voice-conversion | Phase 1 batch 5, Phase 1 complete | Q3-scoped oldest-first final batch, 80 → 87 of 87; processed 2509.16010, 2509.16195, 2509.17143, 2509.18060, 2509.19231, 2509.19812, 2509.24570; 30 claims preserved from 7 structured pages, all with source citations; authoritative closure audit found zero eligible papers remaining, zero extraneous entries, 1 Tier 2 page skipped, and 17 Q4-or-later pages excluded; Phase 1 only, with all method-family assignments and synthesis fields intentionally empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 116 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | voice-conversion (87 papers) | 17 claim_clusters | 7 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 78/87 papers to at least one reciprocal architecture family with 117 memberships, leaving 9 architecture-unspecified survey, evaluation, privacy, or peripheral papers as legitimate outliers; clusters comprise 14 strongly_supported, 2 emerging, and 1 contested, covering content–speaker disentanglement, SSL units, similarity–intelligibility trade-offs, zero-shot reference conditioning, prosody/timbre control, flow matching, diffusion, adversarial training, codec tokens, cross-lingual transfer, non-parallel training, robustness, singing, privacy, evaluation validity, and data diversity; added 6 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 9 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
...
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 180 eligible papers and skipped 4 Tier 2 pages; processed 1609.03499, 1703.10135, 1712.05884, 1904.02882, 2010.05646, 2105.06337, 2204.02152, 2206.04658, 2210.13438, 2301.11325, 2305.07243, 2306.00814, 2402.01912, 2403.16973, 2406.00654, 2406.18009, 2407.05361, 2407.08551, 2409.05377, 2410.17196; 93 claims preserved (1 structured page, 19 legacy), all with source citations; 160 papers remained; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml was 109 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 180; processed 2025.chipsal-1.18, 2025.coling-main.352, 2409.20007, 2025.computel-main.6, 2025.findings-naacl.298, 2025.naacl-demo.21, 2025.naacl-long.464, 2025.naacl-long.619, 2025.naacl-short.69, 2025.iwsds-1.11, 2025.iwsds-1.27, 2025.americasnlp-1.1, 2507.06235, 2505.15772, 2506.23049, 2507.00808, 2507.01611, 2507.02176, 2507.04817, 2507.06116; 83 claims preserved (18 structured pages, 2 legacy), all with source citations; 140 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 109 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 180; processed 2506.09874, 2507.09310, 2506.18296, 2507.14988, 2507.16875, 2025.acl-long.1252, 2025.acl-long.313, 2025.acl-long.388, 2025.acl-long.598, 2025.acl-long.911, 2025.acl-long.937, 2025.acl-long.997, 2025.findings-acl.1226, 2025.findings-acl.470, 2025.findings-acl.534, 2507.20140, 2507.20731, 2025.conll-1.9, 2025.icnlsp-1.34, 2025.sigdial-1.21; 87 claims preserved (15 structured pages, 5 legacy), all with source citations; one previously unseen paper received a fresh full-page extraction; 120 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 109 → 108 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 180; processed 2025.sigdial-1.27, 2508.00317, 2508.01796, 2508.02013, 2507.20091, 2508.05385, 2508.06870, 2508.07711, 2508.08715, 2508.08957, 2504.12867, 2508.09702, 2503.04721, interspeech-2025-0305, interspeech-2025-0383, interspeech-2025-0401, interspeech-2025-0406, interspeech-2025-0408, interspeech-2025-0433, interspeech-2025-0438; 84 claims preserved (6 structured pages, 14 legacy), all with source citations; 100 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 108 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 5 | Q3-scoped oldest-first continuation, 80 → 100 of 180; processed interspeech-2025-0464, interspeech-2025-0469, interspeech-2025-0554, interspeech-2025-0648, interspeech-2025-0656, interspeech-2025-0706, interspeech-2025-0739, interspeech-2025-0762, interspeech-2025-0779, interspeech-2025-0854, interspeech-2025-0902, interspeech-2025-0973, interspeech-2025-0984, interspeech-2025-1066, interspeech-2025-1081, interspeech-2025-1084, interspeech-2025-1098, interspeech-2025-1115, interspeech-2025-1122, interspeech-2025-1210; 86 claims preserved (8 structured pages, 12 legacy), all with source citations; 80 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 108 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 6 | Q3-scoped oldest-first continuation, 100 → 120 of 180; processed interspeech-2025-1229, interspeech-2025-1364, interspeech-2025-1394, interspeech-2025-1397, interspeech-2025-1434, interspeech-2025-1478, interspeech-2025-1531, interspeech-2025-1550, interspeech-2025-1625, interspeech-2025-1638, interspeech-2025-1639, interspeech-2025-1684, interspeech-2025-1726, interspeech-2025-1747, interspeech-2025-1763, interspeech-2025-1776, interspeech-2025-1819, interspeech-2025-1940, interspeech-2025-2031, interspeech-2025-2032; 84 claims preserved from 20 structured pages, all with source citations; one previously unseen paper received a fresh full-page extraction; 60 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 108 → 107 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 7 | Q3-scoped oldest-first continuation, 120 → 140 of 180; processed interspeech-2025-2151, interspeech-2025-2189, interspeech-2025-2283, interspeech-2025-2573, interspeech-2025-2586, interspeech-2025-2595, interspeech-2025-2739, interspeech-2025-2765, interspeech-2025-2787, interspeech-2025-bokkahallisatish25_interspeech, 2508.13028, 2507.16835, 2508.15931, 2508.17031, 2508.17494, 2508.17623, 2509.00675, 2509.00685, 2025.clicit-1.27, 2506.23367; 80 claims preserved (12 structured pages, 8 legacy), all with source citations; 40 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 107 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 8 | Q3-scoped oldest-first continuation, 140 → 160 of 180; processed 2509.03292, 2509.03940, 2509.04072, 2509.04093, 2509.04667, 2509.04685, 2509.05863, 2509.06074, 2509.07038, 2509.07376, 2509.09716, 2509.08696, 2508.18240, 2412.16846, 2509.13989, 2509.14684, 2509.14946, 2505.17093, 2509.15626, 2509.15629; 89 claims preserved (17 structured pages, 3 legacy), all with source citations; one previously unseen paper received a fresh full-page extraction; 20 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 107 → 106 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | subjective-evaluation | Phase 1 batch 9, Phase 1 complete | Q3-scoped oldest-first final batch, 160 → 180 of 180; processed 2509.16010, 2509.16589, 2509.20378, 2509.17021, 2509.17143, 2509.17988, 2509.18470, 2509.18531, 2509.18823, 2509.18928, 2509.19231, 2509.19812, 2509.19883, 2509.19928, 2505.10599, 2509.20802, 2506.21875, 2509.24457, 2509.25416, 2509.26542; 85 claims preserved from 20 structured pages, all with source citations; authoritative discovery found 0 eligible papers remaining and excluded 4 Tier 2 pages; Phase 1 only, with method families and claim clusters left empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 106 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | subjective-evaluation (180 papers) | 17 claim_clusters | 7 method_families | 0 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 133/180 papers to at least one reciprocal architecture family with 177 memberships, leaving 47 architecture-unspecified evaluation, benchmark, dataset, and metric papers as legitimate outliers; 15 clusters strongly_supported, 1 emerging, and 1 contested; contested evidence concerns whether LLM and audio-language-model judges are uniformly reliable for fine-grained and non-verbal speech attributes; added 5 open questions and 5 trend notes covering protocol design, listener context, automated judges, preference trade-offs, and reference design; Phase 2 health check passed with 0 errors and 47 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | spoken-language-model | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 127 eligible papers, skipped 32 Tier 2 pages, and excluded 26 Q4 pages; processed 2209.03143, 2301.02111, 2301.11325, 2305.09636, 2305.11000, 2305.15255, 2306.12925, 2310.00704, 2402.05755, 2402.13236, 2408.02622, 2408.16532, 2408.16725, 2409.06666, 2410.00037, 2410.03751, 2410.11190, 2410.17196, 2410.17799, 2411.00774; 91 claims preserved from 20 legacy pages, all with source citations; 107 papers remained; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 106 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | spoken-language-model | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 127; processed 2411.13577, 2411.17607, 2411.18803, 2411.19842, 2412.02612, 2412.15649, 2501.06282, 2025.coling-industry.29, 2409.20007, 2502.06490, 2502.11946, 2502.17239, 2503.14345, 2504.08528, 2504.10344, iclr-2025-868masI331, iclr-2025-dGSOn7sdWg, iclr-2025-tQ1PmLfPBL, 2025.naacl-demo.12, 2025.naacl-demo.21; 96 claims preserved (7 structured pages, 13 legacy), all with source citations; one previously unseen paper received a fresh full-page extraction; 87 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 106 → 105 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | spoken-language-model | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 127; processed 2025.naacl-long.484, 2505.02625, 2505.09558, 2506.10274, 2507.02380, 2506.23325, 2412.18603, 2507.16632, 2505.15670, 2507.18119, 2507.18897, 2025.acl-long.1252, 2025.acl-long.388, 2025.acl-long.65, 2025.acl-long.654, 2025.acl-long.681, 2025.acl-long.682, 2025.acl-long.817, 2025.acl-long.912, 2025.acl-long.997; 92 claims preserved (10 structured pages, 10 legacy), all with source citations; 67 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 105 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | spoken-language-model | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 127; processed 2025.findings-acl.101, 2025.findings-acl.1051, 2025.findings-acl.115, 2025.findings-acl.470, 2025.findings-acl.534, 2025.findings-acl.631, 2025.findings-acl.75, 2025.findings-ijcnlp.49, 2507.23159, 2025.iwslt-1.5, 2508.02013, 2508.02849, 2508.04585, 2507.20091, 2508.07273, 2508.07375, 2508.08095, 2508.08961, 2508.09600, 2508.11224; 90 claims preserved (8 structured pages, 12 legacy), all with source citations; 47 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 105 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | spoken-language-model | Phase 1 batch 5 | Q3-scoped oldest-first continuation, 80 → 100 of 127; processed 2503.04721, interspeech-2025-0166, interspeech-2025-0246, interspeech-2025-0310, interspeech-2025-0468, interspeech-2025-0739, interspeech-2025-0756, interspeech-2025-0874, interspeech-2025-1289, interspeech-2025-1538, interspeech-2025-1595, interspeech-2025-1641, interspeech-2025-1873, interspeech-2025-2328, interspeech-2025-2564, interspeech-2025-2660, interspeech-2025-bokkahallisatish25_interspeech, 2508.15827, 2508.16188, 2508.16790; 85 claims preserved (7 structured pages, 13 legacy), all with source citations; 27 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 105 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | spoken-language-model | Phase 1 batch 6 | Q3-scoped oldest-first continuation, 100 → 120 of 127; processed 2508.17623, 2508.19205, 2508.20660, 2509.02020, 2509.05359, 2509.03940, 2509.04093, 2509.04685, 2509.04702, 2509.06502, 2509.09716, 2509.09174, 2508.18240, 2509.12171, 2509.14882, 2509.16589, 2509.17765, 2501.04561, 2509.19186, 2509.20410; 88 claims preserved (15 structured pages, 5 legacy), all with source citations; one previously unseen dataset paper received a fresh full-page extraction; 7 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 105 → 104 | runtime: codex | provider: openai | model: gpt-5
- integrate | 7 papers | spoken-language-model | Phase 1 batch 7, Phase 1 complete | Q3-scoped oldest-first final batch, 120 → 127 of 127; processed 2506.21875, 2509.22243, 2510.02352, 2509.23938, 2509.25131, 2509.26276, 2509.26542; 29 claims preserved from 7 structured pages, all with source citations; authoritative discovery found 0 eligible papers remaining, excluded 32 Tier 2 pages and 26 Q4 pages, and found 0 extraneous entries; Phase 1 only, with method families and claim clusters left empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 104 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | spoken-language-model (127 papers) | 17 claim_clusters | 6 method_families | 0 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 99/127 papers to at least one reciprocal architecture family with 142 memberships, leaving 28 architecture-unspecified survey, benchmark, dataset, and evaluation papers as legitimate outliers; 16 clusters strongly_supported and 1 emerging, covering discrete tokenization, semantic-acoustic trade-offs, token rate, unified understanding/generation, speech-text alignment, interleaving, streaming, duplex interaction, paralinguistic competence, memory, long-form generation, data scale, preference alignment, architectural trade-offs, benchmarks, modality gaps, and safety; added 5 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 28 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
...
- integrate | phase 2 only | diffusion-tts (46 papers) | 15 claim_clusters | 7 method_families | 0 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 41/46 papers to one reciprocal architecture family, leaving 5 legitimate architecture-unspecified or diffusion-adjacent outliers; all 15 clusters strongly_supported, covering fidelity, sampling cost, acceleration, latent targets, guidance, transformer scaling, zero-shot transfer, factorized control, expressiveness, robustness, preference optimization, flow/consistency alternatives, alignment, representation choice, and evaluation; added 5 open questions and 5 trend notes; Phase 2 health check passed with 0 errors and 5 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | diffusion-tts | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; authoritative discovery found 46 eligible papers and no Tier 2 exclusions; processed 2105.06337, 2106.15561, 2207.12598, 2210.02747, 2301.12503, 2304.09116, 2305.07243, 2403.03100, 2406.02430, 2411.09943, 2025.coling-main.352, 2502.18924, iclr-2025-hQvX9MBowC, iclr-2025-uxDFlPGRLX, 2025.naacl-long.110, 2025.naacl-long.242, 2507.15272, 2025.ccl-1.77, 2508.01796, interspeech-2025-0063; 88 claims preserved (4 structured pages, 16 legacy), all with source citations; 26 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 93 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | diffusion-tts | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 46; processed interspeech-2025-0554, interspeech-2025-0998, interspeech-2025-1066, interspeech-2025-1101, interspeech-2025-1115, interspeech-2025-1210, interspeech-2025-1236, interspeech-2025-1364, interspeech-2025-1397, interspeech-2025-1434, interspeech-2025-1684, interspeech-2025-1747, interspeech-2025-1763, interspeech-2025-2536, interspeech-2025-gourav25_interspeech, 2508.19205, 2411.19770, 2509.07038, 2509.08379, 2509.08696; 86 claims preserved (17 structured pages, 3 legacy), all with source citations; 6 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 93 | runtime: codex | provider: openai | model: gpt-5
- integrate | 6 papers | diffusion-tts | Phase 1 batch 3, Phase 1 complete | Q3-scoped oldest-first final batch, 40 → 46 of 46; processed 2509.09748, 2509.12831, 2509.14784, 2509.18470, 2509.18928, 2509.25416; 25 claims preserved from 6 structured pages, all with source citations; authoritative discovery found 0 eligible papers remaining; Phase 1 only, with method families and claim clusters left empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 93 | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | zero-shot-tts (203 papers) | 18 claim_clusters | 9 method_families | 0 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 187/203 papers to one reciprocal architecture family, leaving 16 legitimate infrastructure, evaluation, historical-context, or architecture-unspecified outliers; 16 clusters strongly_supported and 2 contested; contested evidence concerns whether cross-lingual cloning necessarily leaks language or prosody and whether automatic metrics consistently fail to capture perceived cloning quality; added 5 open questions and 5 trend notes spanning prompt robustness, representation choice, evaluation, data scale, long-form generation, and safeguards; Phase 2 health check passed with 0 errors and 16 expected method-family coverage warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 1 | first integration pass for this concept; Q3-scoped (`published_date < 2025-10-01`) oldest-first; live discovery found 203 in-scope non-Tier-2 candidates and skipped 3 Tier 2 pages; processed 1712.05884, 1904.02882, 2010.05646, 2206.04658, 2209.03143, 2301.02111, 2303.03926, 2304.09116, 2305.07243, 2305.09636, 2306.12925, 2308.16692, 2310.00704, 2312.01479, 2312.15821, 2401.07333, 2402.01912, 2402.08093, 2402.13236, 2403.03100; 93 claims extracted from 20 legacy-format pages, all with source citations; 183 papers remained; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 203; processed 2403.16973, 2404.03204, 2406.00654, 2406.02430, 2406.04904, 2406.05370, 2406.05551, 2406.07855, 2406.18009, 2407.05361, 2407.05407, 2407.08551, 2409.00750, 2409.03283, 2411.01156, 2411.09943, 2412.04724, 2412.10117, 2412.15649, 2409.09098; 94 claims extracted (2 structured pages, 18 legacy), all with source citations; 163 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 203; processed 2501.06282, 2025.coling-main.685, 2502.04128, 2502.05512, 2502.07243, 2502.18924, 2503.01710, 2503.14345, 2504.02407, iclr-2025-868masI331, iclr-2025-cuFzE8Jlvb, iclr-2025-hQvX9MBowC, 2025.findings-naacl.279, 2025.naacl-demo.12, 2025.naacl-demo.21, 2025.naacl-long.242, 2025.naacl-short.65, 2025.naacl-srw.6, 2505.07916, 2505.13000; 93 claims extracted (9 structured pages, 11 legacy), all with source citations; 143 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 99 → 97 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 203; processed 2505.17589, 2506.13053, 2507.02176, 2507.02380, 2507.03887, 2507.04349, 2507.01348, 2506.09874, 2507.07799, 2507.08319, 2507.09282, 2506.18296, 2507.10985, 2507.12197, 2507.14988, 2507.15272, 2507.16875, 2507.21138, 2025.acl-demo.37, 2025.acl-industry.42; 84 claims extracted (16 structured pages, 4 legacy), all with source citations; 123 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 97 → 96 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 5 | Q3-scoped oldest-first continuation, 80 → 100 of 203; processed 2025.acl-long.1043, 2025.acl-long.1252, 2025.acl-long.1498, 2025.acl-long.313, 2025.acl-long.346, 2025.acl-long.598, 2025.acl-long.65, 2025.acl-long.654, 2025.acl-long.790, 2025.acl-short.81, 2025.findings-acl.115, 2025.findings-acl.1226, 2025.findings-acl.687, 2507.17527, 2507.20140, 2503.11026, 2025.ccl-1.77, 2025.icnlsp-1.34, 2507.22746, 2508.02038; 93 claims extracted (9 structured pages, 11 legacy), all with source citations; 103 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 96 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 6 | Q3-scoped oldest-first continuation, 100 → 120 of 203; processed 2504.10352, 2508.03543, 2508.14049, 2508.04141, 2508.04195, 2508.04585, 2508.04996, 2508.06262, 2508.07302, 2508.07426, 2508.09702, interspeech-2025-0047, interspeech-2025-0305, interspeech-2025-0319, interspeech-2025-0406, interspeech-2025-0455, interspeech-2025-0464, interspeech-2025-0468, interspeech-2025-0551, interspeech-2025-0575; 91 claims extracted (2 structured pages, 18 legacy), all with source citations; 83 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 96 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 7 | Q3-scoped oldest-first continuation, 120 → 140 of 203; processed interspeech-2025-0596, interspeech-2025-0656, interspeech-2025-0787, interspeech-2025-0815, interspeech-2025-0989, interspeech-2025-1081, interspeech-2025-1084, interspeech-2025-1101, interspeech-2025-1115, interspeech-2025-1192, interspeech-2025-1229, interspeech-2025-1236, interspeech-2025-1344, interspeech-2025-1440, interspeech-2025-1531, interspeech-2025-1536, interspeech-2025-1638, interspeech-2025-1641, interspeech-2025-1684, interspeech-2025-1726; 83 claims extracted (12 structured pages, 8 legacy), all with source citations; 63 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 96 → 95 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 8 | Q3-scoped oldest-first continuation, 140 → 160 of 203; processed interspeech-2025-1779, interspeech-2025-1993, interspeech-2025-2031, interspeech-2025-2189, interspeech-2025-2283, interspeech-2025-2447, interspeech-2025-2449, interspeech-2025-2595, interspeech-2025-2765, interspeech-2025-2787, interspeech-2025-2815, interspeech-2025-raju25_interspeech, 2508.15442, 2508.16332, 2508.16790, 2508.17031, 2508.19098, 2508.19205, 2411.19770, 2507.14534; 83 claims extracted (8 structured pages, 12 legacy), all with source citations; 43 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 95 → 94 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 9 | Q3-scoped oldest-first continuation, 160 → 180 of 203; processed 2509.02020, 2502.11128, 2506.21619, 2509.04072, 2509.04685, 2509.05863, 2509.07376, 2509.08379, 2509.08696, 2506.04077, 2509.09631, 2509.09748, 2509.11084, 2509.11425, 2509.12171, 2509.12831, 2509.13068, 2412.16846, 2504.20581, 2509.14579; 89 claims extracted (15 structured pages, 5 legacy), all with source citations; 23 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml decreased 94 → 93 | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | zero-shot-tts | Phase 1 batch 10 | Q3-scoped oldest-first continuation, 180 → 200 of 203; processed 2509.14684, 2509.14784, 2509.15253, 2509.15462, 2509.15845, 2509.15969, 2509.17021, 2509.17516, 2509.17765, 2509.17988, 2509.18928, 2509.19231, 2509.19592, 2509.19668, 2509.19883, 2509.19928, 2509.22718, 2509.20802, 2509.22727, 2509.22062; 86 claims extracted (18 structured pages, 2 legacy), all with source citations; 3 papers remain; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 93 | runtime: codex | provider: openai | model: gpt-5
- integrate | 3 papers | zero-shot-tts | Phase 1 batch 11, Phase 1 complete | Q3-scoped oldest-first final batch, 200 → 203 of 203; processed 2509.22167, 2509.24650, 2509.25131; 14 claims extracted from 3 structured pages, all with source citations; authoritative metadata discovery found 0 eligible papers remaining and excluded 3 Tier 2 records (including 2407.04051, whose paper-page frontmatter omits its metadata-level `ingest_tier: 2`); Phase 1 only, with method families and claim clusters left empty for Phase 2; concept-scoped health check passed with 0 errors and 0 warnings; corpus-wide papers_not_in_any_yaml remained 93 | runtime: codex | provider: openai | model: gpt-5
...
- integrate | 20 papers | prosody-control | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 94; processed interspeech-2025-1098, interspeech-2025-1192, interspeech-2025-1334, interspeech-2025-1494, interspeech-2025-1726, interspeech-2025-1940, interspeech-2025-2032, interspeech-2025-2159, interspeech-2025-2189, interspeech-2025-2684, 2508.13028, 2508.16332, 2508.17031, 2508.17494, 2509.00675, 2025.clicit-1.27, 2509.01391, 2506.21619, 2506.23367, 2509.03940; 84 claims extracted (12 structured pages, 8 legacy), all with source citations; 14 papers remained; Phase 1 only; health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 14 papers | prosody-control | Phase 1 batch 5, Phase 1 closed | Q3-scoped oldest-first final batch, 80 → 94 of 94; processed 2509.04072, 2509.06074, 2509.07038, 2505.17093, 2509.15626, 2509.17143, 2509.17516, 2509.18531, 2509.19231, 2509.19883, 2509.22718, 2509.24570, 2509.24650, 2509.26514; 59 claims extracted (13 structured pages, 1 legacy), all with source citations; live discovery confirmed 0 unintegrated IDs; Phase 1 only, with method families and claim clusters left empty; health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | prosody-control | Phase 1 batch 1 | Q3-scoped (`published_date < 2025-10-01`) oldest-first; live discovery found 94 in-scope non-Tier-2 candidates and skipped 1 Tier 2 page; processed 1609.03499, 1703.10135, 1712.05884, 2006.04558, 2104.00355, 2304.09116, 2402.01912, 2402.08093, 2403.03100, 2406.07855, 2025.coling-main.352, 2025.coling-main.518, 2502.04128, 2502.18924, 2025.nodalida-1.32, 2503.01710, 2025.findings-naacl.38, 2025.findings-naacl.471, 2025.naacl-long.242, 2025.naacl-long.484; 89 claims extracted (4 structured pages, 16 legacy), all with source citations; 74 papers remained; Phase 1 only, with method families and claim clusters left empty; health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | prosody-control | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 94; processed 2507.06235, 2507.01611, 2507.03912, 2507.08012, 2507.04598, 2507.04817, 2507.09310, 2025.acl-industry.42, 2025.acl-long.1471, 2025.acl-long.346, 2025.acl-long.790, 2025.unlp-1.11, 2025.ccl-1.77, 2025.sigdial-1.27, 2508.03543, 2508.04585, 2507.20091, 2508.06890, 2508.07426, 2508.08399; 85 claims extracted (11 structured pages, 9 legacy), all with source citations; 54 papers remained; Phase 1 only; health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | prosody-control | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 94; processed 2508.09702, 2508.09767, 2508.11224, 2508.11273, 2508.12001, interspeech-2025-0047, interspeech-2025-0143, interspeech-2025-0253, interspeech-2025-0347, interspeech-2025-0383, interspeech-2025-0408, interspeech-2025-0433, interspeech-2025-0464, interspeech-2025-0723, interspeech-2025-0754, interspeech-2025-0762, interspeech-2025-0815, interspeech-2025-0902, interspeech-2025-0948, interspeech-2025-1020; 87 claims extracted (5 structured pages, 15 legacy), all with source citations; 34 papers remained; Phase 1 only; health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | instruction-conditioned-tts (44 papers) | 15 claim_clusters | 8 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; assigned 42/44 papers to at least one reciprocal family with 57 total memberships, leaving 2310.00704 and 2502.11946 as deliberate contextual outliers rather than forcing general-purpose audio-language models into an instruction-conditioning family; 8 clusters strongly_supported, 6 emerging, and 1 contested; the contested automatic_judges_do_not_fully_replace_human_evaluation cluster preserves evidence both for high judge-human agreement and for systematic blind spots in perceptual alignment, naturalness, and atypical-speech evaluation; Phase 2 health check passed with 0 errors and 2 expected method-family coverage warnings for the two outliers | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | instruction-conditioned-tts | Phase 1 batch 1 | Q3-scoped (`published_date < 2025-10-01`) oldest-first; live discovery found 44 in-scope non-Tier-2 candidates (one fewer than the prior session-note estimate of 45), with 5 Tier 2 pages skipped; processed 2305.11000 through 2025.acl-long.681; 90 claims extracted (6 structured pages, 14 legacy), all with source citations; 24 papers remained; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | instruction-conditioned-tts | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 44; processed 2025.acl-long.911 through 2505.17093; 85 claims extracted (10 structured pages, 10 legacy), all with source citations; 4 papers remained; Phase 1 only, with method families and claim clusters left empty; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 4 papers | instruction-conditioned-tts | Phase 1 batch 3, Phase 1 closed | Q3-scoped oldest-first final batch, 40 → 44 of 44; processed 2509.15845, 2509.17516, 2509.24570, and 2509.26514; 17 claims extracted from 4 structured pages, all with source citations after correcting four punctuation-obscured citations on 2509.24570; live discovery confirmed 44 candidates and 0 unintegrated IDs; Phase 1 only, with method families and claim clusters left empty; final concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 1 | Q3-scoped (`published_date < 2025-10-01`) oldest-first; live discovery found 165 in-scope non-Tier-2 candidates (one fewer than the 166 recorded on 2026-07-22), 9 Tier 2 pages skipped, 0 already integrated; processed 1609.03499, 1703.10135, 2106.15561, 2209.03143, 2210.13438, 2301.02111, 2301.11325, 2303.03926, 2305.02765, 2305.07243, 2305.09636, 2305.11000, 2306.00814, 2306.12925, 2308.16692, 2310.00704, 2401.07333, 2402.01912, 2402.05755, 2402.08093; 93 legacy-format claims extracted with source citations; 145 papers remain; Phase 1 only, no claim-cluster or method-family synthesis; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 2 | Q3-scoped oldest-first continuation, 20 → 40 of 165; processed 2402.13236, 2403.16973, 2404.03204, 2406.00654, 2406.02430, 2406.04904, 2406.05370, 2406.07855, 2406.18009, 2407.05407, 2407.08551, 2408.02622, 2408.16532, 2408.16725, 2409.00750, 2409.03283, 2409.05377, 2410.00037, 2410.03751, 2410.11190; 93 legacy-format claims extracted with source citations; 125 papers remain; Phase 1 only, no claim-cluster or method-family synthesis; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 3 | Q3-scoped oldest-first continuation, 40 → 60 of 165; processed 2410.17799, 2411.00774, 2411.01156, 2411.17607, 2411.19842, 2412.02612, 2412.10117, 2412.15649, 2502.04128, 2502.05512, 2502.06490, 2502.07243, 2502.11946, 2502.17239, 2503.01710, 2503.14345, 2504.02407, 2504.10344, iclr-2025-868masI331, iclr-2025-cuFzE8Jlvb; 96 claims extracted (2 structured pages, 18 legacy), all with source citations; 105 papers remain; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 4 | Q3-scoped oldest-first continuation, 60 → 80 of 165; processed iclr-2025-dGSOn7sdWg, 2025.findings-naacl.184, 2025.findings-naacl.279, 2025.naacl-demo.12, 2025.naacl-long.591, 2025.naacl-srw.6, 2505.02625, 2505.07916, 2505.13000, 2505.17589, 2506.10274, 2507.02380, 2507.01348, 2506.23325, 2507.09070, 2507.12197, 2507.16632, 2507.21138, 2507.18897, 2025.acl-long.1043; 94 claims extracted (12 structured pages, 8 legacy), all with source citations after correcting one punctuation-obscured §3.3 citation; 85 papers remain; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 5 | Q3-scoped oldest-first continuation, 80 → 100 of 165; processed 2025.acl-long.1498, 2025.acl-long.65, 2025.acl-long.654, 2025.acl-long.682, 2025.acl-long.912, 2025.acl-long.937, 2025.acl-short.81, 2025.findings-acl.101, 2025.findings-acl.1051, 2025.findings-ijcnlp.49, 2025.conll-1.9, 2025.ccl-1.80, 2025.icnlsp-1.34, 2507.22746, 2504.10352, 2508.14049, 2508.04141, 2508.04585, 2507.20091, 2508.06262; 92 claims extracted (5 structured pages, 15 legacy), all with source citations; 65 papers remain; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 6 | Q3-scoped oldest-first continuation, 100 → 120 of 165; processed 2508.08715, 2508.08961, 2504.12867, 2508.09767, 2508.11326, interspeech-2025-0253, interspeech-2025-0319, interspeech-2025-0355, interspeech-2025-0464, interspeech-2025-0468, interspeech-2025-0551, interspeech-2025-0669, interspeech-2025-0704, interspeech-2025-0874, interspeech-2025-0989, interspeech-2025-1084, interspeech-2025-1289, interspeech-2025-1538, interspeech-2025-1641, interspeech-2025-1776; 85 claims extracted (5 structured pages, 15 legacy), all with source citations; 45 papers remain; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 7 | Q3-scoped oldest-first continuation, 120 → 140 of 165; processed interspeech-2025-1993, interspeech-2025-2328, interspeech-2025-2447, interspeech-2025-2536, interspeech-2025-2564, interspeech-2025-2726, 2508.15827, 2508.15442, 2508.16332, 2508.16790, 2508.19098, 2508.19205, 2509.00503, 2509.00685, 2509.02020, 2502.11128, 2506.21619, 2509.04685, 2509.05863, 2509.09174; 90 claims extracted (7 structured pages, 13 legacy), all with source citations; 25 papers remain; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 20 papers | autoregressive-codec-tts | Phase 1 batch 8 | Q3-scoped oldest-first continuation, 140 → 160 of 165; processed 2509.09550, 2509.11425, 2509.13068, 2412.16846, 2509.13670, 2509.14784, 2509.14882, 2509.14946, 2509.15845, 2509.15969, 2509.20378, 2509.17021, 2509.17516, 2509.18531, 2509.19025, 2509.19186, 2509.19592, 2505.10599, 2509.20802, 2509.21968; 89 claims extracted (19 structured pages, 1 legacy), all with source citations; 5 papers remain; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | 5 papers | autoregressive-codec-tts | Phase 1 batch 9, Phase 1 closed | Q3-scoped oldest-first final batch, 160 → 165 of 165; processed 2509.22062, 2509.24570, 2509.24650, 2509.25131, 2509.26514; 21 claims extracted from 5 structured pages, all with source citations after correcting four punctuation-obscured citations on 2509.24570; live discovery confirmed 165 candidates and 0 unintegrated IDs; Phase 1 only; concept-scoped health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
- integrate | phase 2 only | autoregressive-codec-tts (165 papers) | 17 claim_clusters | 13 method_families | 5 reassessment_queue items | first synthesis pass after Phase 1 closed; all 165 papers assigned reciprocally to at least one family, with 264 total family memberships; 15 clusters strongly_supported, 1 contested, 1 emerging; polarity audit corrected `parallel_and_masked_models_challenge_full_autoregression` from an over-broad strongly-supported result to contested (4 supporting, 3 contradicting, 1 refining) because matched evidence includes both SoundStorm-style latency/quality gains and UniAudio/low-step masked-decoding quality penalties; `continuous_representations_avoid_quantization_tradeoffs` remains emerging on 2 papers; the two largest families (`hybrid_ar_token_continuous_renderer`, 52 papers; `semantic_acoustic_token_cascade`, 43 papers) were added to reassessment for future sub-splitting; Phase 2 health check passed with 0 errors and 0 warnings | runtime: codex | provider: openai | model: gpt-5
