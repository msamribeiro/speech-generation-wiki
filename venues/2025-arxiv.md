...
The arXiv 2025 corpus spans the full range of tasks: TTS (majority), VC ([[2507.14534]], [[2508.16332]]), codec ([[2510.00981]]), singing ([[2508.16332]]), and SCA ([[2412.17048]], [[2509.02020]]). Dominant themes: (1) unified speech + singing models via chromagram-based tokenization ([[2508.16332]] Vevo2); (2) emotion control as a research focus — both training-based ([[2508.02038]] Marco-Voice, [[2508.11273]] EmoSSLSphere) and training-free activation steering ([[2508.03543]] EmoSteer-TTS); (3) hybrid AR+diffusion for continuous speech generation ([[2502.03930]] DiTAR); (4) attention-free flow matching with enriched priors ([[2510.02848]] Flamed-TTS, 10x lower RTF than F5-TTS); (5) production-level TTS engineering with GRPO multi-reward RL ([[2512.14291]] GLM-TTS); (6) codec-free and continuous-token AR TTS challenging the VQ paradigm ([[2502.11128]] FELLE, [[2508.19098]] CLEAR, [[2508.04141]] Parallel GPT); (7) RL preference optimization as standard post-training for AR TTS ([[2509.00685]] MPO); (8) streaming first-packet latency pushed below 102 ms ([[2509.15969]] VoXtream); (9) flow-matching distillation into 1–3 inference steps ([[2510.07979]] IntMeanFlow).
