...
> [!abstract]
> A living systematic review of the state of the art in synthetic speech, covering **text-to-speech (TTS)**, **voice conversion (VC)**, and **spoken conversational agents (SCA)**. 549 papers ingested · 24 concepts · Last updated 2026-07-14.
...
Field reports synthesise changes across multiple ingestion passes, tracking shifts in dominant approaches, emerging trends, and contested claims. The first report is due — 549 papers ingested.
